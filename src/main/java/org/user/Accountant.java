...
public class Accountant extends User{
    ...
    public Accountant(String username, String firstName, String lastName) {
    ...
    public boolean equals(Accountant accountant){
        return this.getUsername().equals(accountant.getUsername());
    }
